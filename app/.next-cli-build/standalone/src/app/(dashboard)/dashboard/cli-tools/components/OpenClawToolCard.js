...
function OpenClawExpandedSection({ agentModels, applying, checkingOpenclaw, customBaseUrl, getDisplayUrl, handleApplySettings, handleResetSettings, message, openclawStatus, restoring, selectedApiKey, selectedModel, setAgentModalFor, setAgentModels, setCustomBaseUrl, setModalOpen, setSelectedApiKey, setSelectedModel, setShowManualConfigModal, tool }) {
  return (
...
export default function OpenClawToolCard({
  ...
  return (
    <Card padding="xs" className="overflow-hidden">
      ...
      {isExpanded && <OpenClawExpandedSection agentModels={agentModels} applying={applying} checkingOpenclaw={checkingOpenclaw} customBaseUrl={customBaseUrl} getDisplayUrl={getDisplayUrl} handleApplySettings={handleApplySettings} handleResetSettings={handleResetSettings} message={message} openclawStatus={openclawStatus} restoring={restoring} selectedApiKey={selectedApiKey} selectedModel={selectedModel} setAgentModalFor={setAgentModalFor} setAgentModels={setAgentModels} setCustomBaseUrl={setCustomBaseUrl} setModalOpen={setModalOpen} setSelectedApiKey={setSelectedApiKey} setSelectedModel={setSelectedModel} setShowManualConfigModal={setShowManualConfigModal} tool={tool} />}
