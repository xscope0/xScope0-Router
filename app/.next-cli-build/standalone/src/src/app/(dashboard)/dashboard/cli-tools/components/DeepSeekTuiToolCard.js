...
function DeepSeekTuiExpandedSection({ applying, checking, customBaseUrl, deepseekStatus, getEffectiveBaseUrl, handleApply, handleReset, message, restoring, selectedApiKey, selectedModel, setCustomBaseUrl, setModalOpen, setSelectedApiKey, setSelectedModel, setShowManualConfigModal, tool }) {
  return (
