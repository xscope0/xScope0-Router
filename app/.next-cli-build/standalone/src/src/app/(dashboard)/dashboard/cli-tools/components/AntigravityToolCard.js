...
function AntigravityExpandedSection({ handleModelMappingChange, handleSaveMappings, handleStart, handleStop, isRunning, loading, message, modelMappings, openModelSelector, selectedApiKey, serverIsWindows, setSelectedApiKey, startingStep, status, tool }) {
  return (
...
export default function AntigravityToolCard({
  ...
  return (
    <Card padding="xs" className="overflow-hidden">
      ...
      {isExpanded && <AntigravityExpandedSection handleModelMappingChange={handleModelMappingChange} handleSaveMappings={handleSaveMappings} handleStart={handleStart} handleStop={handleStop} isRunning={isRunning} loading={loading} message={message} modelMappings={modelMappings} openModelSelector={openModelSelector} selectedApiKey={selectedApiKey} serverIsWindows={serverIsWindows} setSelectedApiKey={setSelectedApiKey} startingStep={startingStep} status={status} tool={tool} />}
