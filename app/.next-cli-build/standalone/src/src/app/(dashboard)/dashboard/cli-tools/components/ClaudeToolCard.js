...
export default function ClaudeToolCard({
  ...
  return (
    <Card padding="xs" className="overflow-hidden">
      ...
      {isExpanded && <ClaudeExpandedSection applying={applying} ccFilterNaming={ccFilterNaming} checkingClaude={checkingClaude} claudeStatus={claudeStatus} customBaseUrl={customBaseUrl} env={claudeStatus?.settings?.env || {}} getDisplayUrl={getDisplayUrl} handleApplySettings={handleApplySettings} handleCcFilterNamingToggle={handleCcFilterNamingToggle} handleResetSettings={handleResetSettings} message={message} openModelSelector={openModelSelector} restoring={restoring} selectedApiKey={selectedApiKey} setCustomBaseUrl={setCustomBaseUrl} setSelectedApiKey={setSelectedApiKey} setShowInstallGuide={setShowInstallGuide} setShowManualConfigModal={setShowManualConfigModal} showInstallGuide={showInstallGuide} tool={tool} /> }
