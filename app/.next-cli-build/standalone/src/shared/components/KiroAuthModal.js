 ...
 */
export default function KiroAuthModal({ isOpen, onMethodSelect, onClose, initialSelectedMethod, initialFlowKey }) {
  ...
  useEffect(() => {
    if (!isOpen || !initialSelectedMethod) return;
    setSelectedMethod(initialSelectedMethod);
    setError(null);
  }, [isOpen, initialSelectedMethod, initialFlowKey]);
